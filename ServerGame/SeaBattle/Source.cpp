...
void drawField(unsigned char player1Field[][10], unsigned char player2Field[][10]) {  //доделать: функция должна по-разному рисовать поле для разных игроков
    system("cls");
   printf("%s\n", field[0]);
   printf("%s\n", field[1]);
    ...
    *endFigure = (int)arr[3] - '0';
    ...
    if (*beginLetterCh > 9 || *beginLetterCh < 0 || *beginFigure > 9 || *beginFigure < 0 ||
        *endLetterCh > 9 || *endLetterCh < 0 || *endFigure > 9 || *endFigure < 0) {
        printf("Unable to place the ship. Enter other coordinates\n");
...
void generationShips(int sizeOfShip, unsigned char gameField[][10], unsigned char gameField2[][10]) {
    ...
    case 4:
    {
        printf("Enter the start and end coordinates for a four-deck ship:\n");
        readCoordinates4(&beginLetterCh, &beginFigure, &endLetterCh, &endFigure);
    ...
    case 3:
    {
        printf("Enter the start and end coordinates for a three-deck ship:\n");
        readCoordinates4(&beginLetterCh, &beginFigure, &endLetterCh, &endFigure);
    ...
    case 2:
    {
        printf("Enter the start and end coordinates for a two-deck ship:\n");
        readCoordinates4(&beginLetterCh, &beginFigure, &endLetterCh, &endFigure);
    ...
    {
        int temp = 49;
        printf("Enter the start and end coordinates for a one-deck ship:\n");
        readCoordinates2(&beginLetterCh, &beginFigure);
